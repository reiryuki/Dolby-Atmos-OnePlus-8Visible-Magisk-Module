...
# conflict
NAMES="dolbyatmos DolbyAudio MotoDolby dsplus Dolby"
conflict
...
hide_oat
APPS="MusicFX MotoDolbyDax3 MotoDolbyV3 DolbyAtmos AudioEffectCenter"
hide_app
...
# check
NAMES="libqtigef.so libstagefrightdolby.so libdeccfg.so
