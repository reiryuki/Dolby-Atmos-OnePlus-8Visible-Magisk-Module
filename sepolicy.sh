...
magiskpolicy --live "dontaudit mediacodec_exec labeledfs filesystem associate"
magiskpolicy --live "allow     mediacodec_exec labeledfs filesystem associate"
magiskpolicy --live "dontaudit init mediacodec_exec file relabelfrom"
magiskpolicy --live "allow     init mediacodec_exec file relabelfrom"
